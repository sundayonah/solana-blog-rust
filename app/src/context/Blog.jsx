...
export const BlogProvider = ({ children }) => {
   ...
   const createPost = async (name, title, content) => {
      if (program && publicKey) {
         setTransactionPending(true);
         ...
         try {
            ...
            // Assuming clockPubkey is the public key for the Sysvar Clock account
            // const clockPubkey = await PublicKey.default.readonly();
            ...
            const result = await program.methods
               ...
               .accounts({
                  ...
                  authority: publicKey,
                  systemProgram: SystemProgram.programId,
                  // clock: clockPubkey, // Pass the lock account
               })
               .rpc();
            console.log(result);
